...
class MixLabSurface extends StatefulWidget {
  final String endpoint;
  const MixLabSurface({super.key, required this.endpoint});

  @override
  State<MixLabSurface> createState() => _MixLabSurfaceState();
}

class _MixLabSurfaceState extends State<MixLabSurface> {
  static const _lastUrlKey = 'mixlab.lastUrl';
